 ...
 class Crud extends CI_Controller {  
      ...
      function fetch_user(){  
           ...
           {  
                ...
                $sub_array[] = '<button type="button" name="update" id="'.$row->empId.'" class="btn btn-warning btn-xs">Update</button>';  
                $sub_array[] = '<button type="button" name="delete" id="'.$row->empId.'" class="btn btn-danger btn-xs">Delete</button>';  
                $data[] = $sub_array;  
           }  
           $output = array(  

                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        <a  href="<?php echo base_url().'index.php/item'; ?>" class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>TreeView<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                    </li>
                  
                    <li class="no-padding">
                        <a href="<?php echo base_url().'index.php/product'; ?>" class="collapsible-header waves-effect waves-grey"><i class="material-icons">account_box</i>Employees<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <!--div class="collapsible-body"-->
                            <!--ul-->
